...
public class MetalonFollow : MonoBehaviour
{
    private MetalonAnimator metalonAnimator;
    ...
    {
        //Initialising
        metalonAnimator = GetComponent<MetalonAnimator>();
    ...
    void Chase()
    {
        ...
        if (navAgent.velocity.sqrMagnitude > 0)
        {
            metalonAnimator.Run(true);
        }
        else
        {
            metalonAnimator.Run(false);
        }
